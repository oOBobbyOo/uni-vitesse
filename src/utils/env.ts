// @see https://zh.uniapp.dcloud.io/tutorial/platform.html
...
enum EPlatform {
  ...
  /** 360小程序 */
  Mp360 = 'MP-360',
  /** 微信小程序/支付宝小程序/百度小程序/抖音小程序/飞书小程序/QQ小程序/360小程序 */
  Mp = 'MP',
  /** 快应用通用(包含联盟、华为) */
...
/** 飞书小程序 */
export const isMpLark = platform === EPlatform.MpLark
/** QQ小程序 */
export const isMpQq = platform === EPlatform.MpQq
/** 快手小程序 */
export const isMpKuaiShou = platform === EPlatform.MpKuaiShou
/** 京东小程序 */
export const isMpJd = platform === EPlatform.MpJd
/** 360小程序 */
